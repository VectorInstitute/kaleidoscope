...
def reshard_mp(
    ...
    if not Path(f"{save_prefix}-{middle}.pt").exists():
    ...
    paths_to_load = get_paths_to_load(
        ...
        f"{save_prefix}-{middle}.pt", suffix="-shard"
    )
    logger.info(
...
"""
#python -m metaseq.scripts.orig_reshard_mp 30B-mp8/reshard_no_os/reshard /scratch/ssd002/projects/opt_test/OPT-30B-mp8-shard4/ --part 0 --target_ddp_size 4
python -m metaseq.scripts.orig_reshard_mp 30B-mp8/reshard_no_os/reshard /scratch/ssd002/projects/opt_test/OPT-30B-mp8-shard4/ --mpart 8 --target_ddp_size 4
"""

if __name__ == "__main__":
    #Fire(reshard_mp)
    Fire(reshard_all_parts)
