...
def main(cfg: DictConfig) -> None:
    ...
    cfg.bpe = {'_name': 'hf_byte_bpe', 
           'bpe_merges': '/scratch/ssd001/home/jba/OPT/gpt2-merges.txt', 
           'bpe_vocab': '/scratch/ssd001/home/jba/OPT/gpt2-vocab.json', 
    ...
    epoch_itr = task.get_batch_iterator(
            dataset=task.build_dataset_for_online_training(tokens, lengths),
            max_tokens=None,
            max_sentences=8,
            max_positions=None,
...
def cli_main(
    ...
    ##########################
    #SYSTEM_ARGS = [
    #    " /scratch/ssd001/home/jba/OPT/175B/reshard_no_os/reshard.pt",
    #    "--num-workers 32",
    #    #"--num-workers-valid 0", 
    #    "--model-parallel-size 32 --distributed-world-size 32 --distributed-port 13000",
    #    "--merges-filename /scratch/ssd001/home/jba/OPT/gpt2-merges.txt",
    #    "--vocab-filename /scratch/ssd001/home/jba/OPT/gpt2-vocab.json",
    #    "--finetune-from-model /scratch/ssd001/home/jba/OPT/175B/reshard_no_os/reshard.pt",
    #    #"--reset-dataloader", 
    ...
    #    "--decoder-layers 96 --decoder-embed-dim 12288",
    #    "--decoder-ffn-embed-dim 49152 --decoder-attention-heads 96",
    #    "--decoder-learned-pos --no-scale-embedding",
    #    "--tokens-per-sample 2048",
    #    "--sample-break-mode none", #one sample per sequence?
    #]
    #SYSTEM_ARGS = [
    #    " /scratch/ssd001/home/jba/OPT/66B/reshard_no_os/reshard.pt",
    #    "--num-shards 4",
    #    "--num-workers 32",
    #    #"--num-workers-valid 0", 
    #    "--model-parallel-size 8 --distributed-world-size 32 --distributed-port 13000",
    #    "--merges-filename /scratch/ssd001/home/jba/OPT/gpt2-merges.txt",
    #    "--vocab-filename /scratch/ssd001/home/jba/OPT/gpt2-vocab.json",
    #    #"--finetune-from-model /scratch/ssd001/home/jba/OPT/66B/reshard_no_os/reshard.pt",
    #    #"--reset-dataloader", 
    #    #"reset_lr_scheduler=False, reset_meters=False, reset_optimizer=False",
    #]
    #MODEL_ARGS = [
    ...
    #    "--criterion vocab_parallel_cross_entropy",
    #    "--share-decoder-input-output-embed",
    #    "--decoder-layers 64 --decoder-embed-dim 9216",
    #    "--decoder-ffn-embed-dim 36864 --decoder-attention-heads 72",
    #    "--decoder-learned-pos --no-scale-embedding",
    #    "--tokens-per-sample 2048",
    #    "--sample-break-mode none", #one sample per sequence?
    #]
    #SYSTEM_ARGS = [
    #    " /scratch/ssd001/home/jba/OPT/30B-mp8/reshard_no_os/reshard.pt",
    #    "--num-shards 4",
    #    "--num-workers 16",
    #    #"--num-workers-valid 0", 
    #    "--model-parallel-size 8 --distributed-world-size 32 --distributed-port 13000",
