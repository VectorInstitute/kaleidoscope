...
def initialize_model(model_type, model_variant):
    ...
    """
    return importlib.import_module(f".models.{model_type}.model", "kaleidoscope.model_service").Model(model_type, model_variant)
...
class ModelService():
    ...
    def run(self):
        ...
        if model.rank == 0:
            ...
            # triton_config = TritonConfig(http_address="0.0.0.0", http_port=self.master_port, log_verbose=4, grpc_port=8180, metrics_port=8181)
